# /Users/radiant/Desktop/RXinDexer/clean_sync.py
# This script provides a clean, transaction-safe blockchain sync for the RXinDexer
# It completely avoids problematic JOINs and uses isolated connections for each operation
            ...
            with self.get_db_connection() as conn:
                with conn.cursor() as cur:
                    for utxo in spent_utxos:
                        ...
                        cur.execute("""
                            UPDATE utxos 
                            SET spent = TRUE, spent_txid = %s, updated_at = %s
                ...
                with conn.cursor() as cur:
                    for utxo in new_utxos:
                        ...
                        """, (
                            ...
                            current_time   # updated_at for ON CONFLICT
                        ))
