...
.. _`contrib/systemd/electrumx.service`: https://github.com/Radiant-Core/ElectrumX/blob/master/contrib/systemd/electrumx.service
...
.. _`contrib/raspberrypi3/install_electrumx.sh`: https://github.com/Radiant-Core/ElectrumX/blob/master/contrib/raspberrypi3/install_electrumx.sh
.. _`contrib/raspberrypi3/run_electrumx.sh`: https://github.com/Radiant-Core/ElectrumX/blob/master/contrib/raspberrypi3/run_electrumx.sh
